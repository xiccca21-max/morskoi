...
export function Toaster() {
  ...
  return (
    <div
      ...
      aria-live="polite"
    >
      {/* Без AnimatePresence/exit: в Telegram WebView анимация выхода роняла
          removeChild и поднимала ErrorBoundary на каждой странице. Тосты просто
          появляются (entrance), а скрываются мгновенно по таймеру стора. */}
      {toasts.map((t) => {
